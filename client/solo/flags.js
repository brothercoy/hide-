...
export const FLAGS = [
    ...
    { id: 'c3', name: 'RUSSIA', art: [
        ...
        // Measured to three EQUAL 1.94-row bands, flush at the boundaries (no seams), border ink
        // to border ink: white −0.5..1.44, blue ink 1.44..3.38 (4 solid rows), red 3.38..5.31.
        { ch: '####################', x: 10, y: 1.75 },
        { ch: '####################', x: 10, y: 2.21 },
        { ch: '####################', x: 10, y: 2.67 },
        { ch: '####################', x: 10, y: 3.13 },
