...
export class PlayScreen {
    ...
    enter() {
        ...
        this.ui.buttons.push(makeButton('QUICK JOIN',  qjX, btnRowY, () => this.onQuickJoin(this.nameInput.value),  { blocksInput: true }));   // matchmakes into any available public lobby
